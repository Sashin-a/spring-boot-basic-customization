...
import com.springboot.customization.failureanalyzer.utils.ListAppender;
...
public class FailureAnalyzerAppIntegrationTest {
    ...
    private static final String EXPECTED_ANALYSIS_DESCRIPTION_CONTENT = "The bean myDAO could not be injected as MyDAO because it is of type MySecondDAO";
    private static final String EXPECTED_ANALYSIS_ACTION_TITLE = "Action:";
    private static final String EXPECTED_ANALYSIS_ACTION_CONTENT = "Consider creating a bean with name myDAO of type MyDAO";
